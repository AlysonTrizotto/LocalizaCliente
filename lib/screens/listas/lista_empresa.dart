  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        // Botão Flutuante
        child: Icon(Icons.add_business_rounded), //Icone do botão
        ...
        onPressed: () {
          ...
          lista_favoritos();
        }, // Onde vai armazenar a classe responsável pelo efeito do botão ou ação
      ),
      appBar: AppBar(
        //Barra com Título
        title: Text('Lista de favoritoss'), // Título
      ),
    );
  }
}
